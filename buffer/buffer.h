 ...
 * @author: peizhic
 * 
 * Create a buffer (based on vector) for read and write data
 * This buffer will automatically increase according to the designed space, 
 * rather than doubling to twice the space.
*/
